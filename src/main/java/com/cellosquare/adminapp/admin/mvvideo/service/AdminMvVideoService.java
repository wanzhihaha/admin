package com.cellosquare.adminapp.admin.mvvideo.service;
...
public interface AdminMvVideoService {
    ...
    void saveVideo(MultipartHttpServletRequest muServletRequest, AdminMvVideoVO vo);
}
