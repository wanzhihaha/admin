        ...
        <article>
            <div class="Cont_place">
                <table class="bd-form" summary="등록, 수정하는 영역 입니다.">
                    ...
                    <tr>
                        <th scope="row">PC端图片</th>
                        <td>
                            <c:if test="${!empty detail.adPicUrl}">
                                <img src="<blabProperty:value key="system.admin.path"/>/advertising/blogImgView.do?id=<c:out value='${detail.id}'/>&imgKinds=articlePicBig"
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${!empty detail.adMobilePicUrl}">
                                <img src="<blabProperty:value key="system.admin.path"/>/advertising/blogImgView.do?id=<c:out value='${detail.id}'/>&imgKinds=mobileList"
                                     style="max-width: 100px; vertical-align: middle;">
                            </c:if>
                        </td>
                    </tr>
