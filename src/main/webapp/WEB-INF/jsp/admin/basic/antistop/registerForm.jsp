...
<%--		</c:otherwise>--%>
<%--	</c:choose>--%>
	<div class="title"><h3>创建关键词</h3></div>
	<article>
	...
	<table class="bd-form" summary="등록, 수정하는 영역 입니다.">
			...
			<tr>
				<th colspan="2" style="text-align: center; font-weight: bold; font-size: large; border-top: 1px solid; border-bottom: 1px solid;">关键词</th>
			</tr>
		<tr>
			<th scope="row">关键词*</th>
			<td>
				<input id="terminologyName" name="terminologyName" type="text" required="required" placeholder="请输入关键词" class="inp-field widL" value="<c:out value="${detail.terminologyName }" escapeXml="false"/>" maxlength="500" data-vmsg="product name in English"/>
			</td>
		</tr>

		<tr>
			<th scope="row">关键词内容*</th>
			<td>
				<div class="textCont">
					<textarea name="description" id="description" class="textarea" rows="10" cols="65" placeholder="请输入关键词" maxlength="475" data-vmsg="summary information"><c:out value="${detail.description }" escapeXml="false"/></textarea>
				</div>
			</td>
		</tr>
		<tr>
